...
metadata:
  ...
  tags: [prd, product, specifications, ai-features, requirements]
---

# PRD Writer — AI Era Product Specifications

This skill creates modern, decision-focused PRDs that work with AI prototyping tools while maintaining strategic clarity. Based on proven practices from leading tech companies including OpenAI, Figma, Cursor, and Linear.
...
Even with AI prototyping tools (Cursor, Lovable, v0), PRDs remain critical because prototypes don't specify:
...
### 1. Opportunity Framing (The "Why")

- **Core Problem**: One-sentence summary of the issue.
- **User Evidence**: Grounded in actual customer pain points. *Note: 40% of product leaders consider customer insights the most important input for strategy. Never proceed without validated evidence.*
- **Working Hypothesis**: One-sentence proposed answer.
- **Strategy Fit & Clear Vision**: Define the immediate initiative this unlocks AND the long-term "North Star" product vision it serves.
- **Market Awareness & Business Value**: Explicitly state the projected revenue/retention impact and market positioning.
...
- `references/ai-examples.md` — 50+ AI behavior examples from Cursor, Granola, Figma, Lovable, Linear
- `references/before-after.md` — Real PRD transformations
- `references/metrics-library.md` — Common metrics with thresholds by domain
